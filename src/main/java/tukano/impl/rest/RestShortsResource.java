...
public class RestShortsResource extends RestResource implements RestShorts {
	...
	@Override
	public void deleteAllShorts(SecurityContext sc, String userId) {
		super.resultOrThrow( impl.deleteAllShorts(sc, userId));
	}

	@Override
	public void updateShortViews(String shortId, Long views) {
		super.resultOrThrow( impl.updateShortViews(shortId, views));
	}
}
